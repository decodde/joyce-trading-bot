    ...
    oneStream: async (symbol, id, quantity) => {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            api.stream.kline({ symbol: symbol, interval: '1m' }, async (data) => {
                ...
                var one_r_away = resistance.one_resistance_away ? resistance.one_resistance_away.p : supports.one_support_away.p;
...
var _ema = async (symbol) => {
    try {
        ...
        var _symbol = `${sp[0]}/USDT`;
        console.log(_symbol)
        let emaData_200 = await ema(200, "close", "binance", _symbol, config.botTimeFrame, true);
        console.log(emaData_200[emaData_200.length - 1])
    }
    catch (e) {
        console.log(e)
    }
